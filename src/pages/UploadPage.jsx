...
export default function UploadPage() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (!file) {
      showToast("Please attach an audio file", "error");
      return;
    }
    if (!form.title || !form.genre || !form.bpm || !form.price) {
    ...
    return (
      ...
      >
        <div style={{ textAlign: "center", maxWidth: 400 }}>
          <CheckCircle
            size={56}
            style={{ color: "var(--gold)", margin: "0 auto 1rem" }}
          />
          <h2
            style={{
          ...
          <p style={{ color: "var(--text-muted)", marginBottom: "2rem" }}>
            "{form.title}" is now live in the beat store after review.
          </p>
          <button
            onClick={() => {
              setDone(false);
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div
            ...
            style={{
              ...
              background: dragging ? "rgba(201,168,76,0.05)" : "var(--surface)",
              transition: "all 0.2s",
              marginBottom: "2rem",
            }}
          >
          ...
          >
            <div>
              ...
              <input
                ...
                placeholder="e.g. Midnight Throne"
                value={form.title}
                onChange={(e) =>
            ...
            <div>
              ...
              <input
                className="input-dark rounded-xl px-4 py-3 text-sm font-mono-dm"
                placeholder="e.g. 140"
                type="number"
                min="60"
                max="200"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setForm((f) => ({ ...f, exclusive: e.target.value }))
                }
                style={{padding:10}}
              />
            </div>
          ...
          <div style={{ marginBottom: "2rem" }}>
            ...
            <input
              className="input-dark rounded-xl px-4 py-3 text-sm"
              placeholder="e.g. dark, cinematic, heavy"
              value={form.tags}
          ...
          <button
            type="submit"
            disabled={uploading}
            className="btn-gold px-10 py-4 rounded-xl text-sm flex items-center gap-2"
            style={{padding:10}}
          >
            <Upload size={16} />{" "}
            {uploading ? `Uploading ${Math.round(progress)}%…` : "Publish Beat"}
          </button>
        </form>
      </div>
