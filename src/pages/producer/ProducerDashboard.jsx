...
export default function ProducerDashboard({ setActivePage }) {
  ...
  const totalRevenue = mySessions
    .filter((b) => b.status === "completed")
    .reduce((s, b) => s + b.price * 0.6, 0)
    .toFixed(2);
          ...
          <div>
            ...
            >
              ...
              <span className="gold-text">
                {user?.name?.split(" ")[0]?.toUpperCase() || "PRODUCER"}
              </span>
            </h1>
          </div>
          <div style={{ display: "flex", gap: "0.75rem" }}>
            {unread > 0 && (
              <button
                ...
                className="btn-outline px-4 py-3 rounded-xl text-sm flex items-center gap-2"
                      ...
                      style={{
                        ...
                        background:
                          s.status === "confirmed"
                            ...
                            : "rgba(201,168,76,0.1)",
                        color:
                          s.status === "confirmed" ? "#22c55e" : "var(--gold)",
                        fontWeight: 700,
                        textTransform: "uppercase",
                      }}
                    >
              ...
              <div style={{ overflowX: "auto" }}>
                <table style={{ width: "100%", borderCollapse: "collapse" }}>
                  <thead>
                    ...
                    >
                      {["Beat", "Genre", "BPM", "Price", "Plays", "Status"].map(
                        (h) => (
                          <th
                            key={h}
                            style={{
                          ...
                          >
                            <div
                              style={{
                                ...
                                height: 34,
                                borderRadius: 7,
                                background: `linear-gradient(135deg, hsl(${b.id * 47},40%,14%), hsl(${b.id * 47 + 60},30%,9%))`,
                                flexShrink: 0,
                              }}
                            />
