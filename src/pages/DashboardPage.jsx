...
const myBeats = beats.slice(0, 4).map((b) => ({
  ...b,
  sales: Math.floor(Math.random() * 20) + 1,
  revenue: (Math.floor(Math.random() * 20) + 1) * b.price,
}));
    ...
    <div style={{ paddingTop: 64, minHeight: "100vh" }}>
      ...
      >
        ...
        >
          ...
          <button
            ...
            className="btn-gold p-10 rounded-xl text-sm flex items-center gap-2"
          >
      ...
      >
                        ...
                        >
                          <div
                            style={{
                              ...
                              height: 36,
                              borderRadius: 8,
                              background: `linear-gradient(135deg, hsl(${b.id * 47}, 40%, 15%), hsl(${b.id * 47 + 60}, 30%, 10%))`,
                              flexShrink: 0,
                            }}
                          />
                          <div>
        ...
        >
          <button
            onClick={() => setActivePage("upload")}
            className="btn-gold px-6 py-3 rounded-xl text-sm flex items-center gap-2"
          >
