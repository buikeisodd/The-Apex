      ...
      >
        ...
        <div>
          <form
            ...
            style={{ display: "flex", flexDirection: "column", gap: "1.25rem", padding:10 }}
          >
            <div
              style={{
                display: "grid",
                ...
                {enquiryTypes.map((t) => (
                  <button
                    ...
                    style={{
                      ...
                      background:
                        form.type === t ? "var(--gold)" : "var(--surface2)",
                      color:
                        form.type === t ? "var(--black)" : "var(--text-muted)",
                      border:
                        form.type === t
                          ? "none"
            ...
            <button
              type="submit"
              disabled={loading}
              className="btn-gold py-4 rounded-xl text-sm flex items-center justify-center gap-2"
              style={{ maxWidth: 280, padding:10 }}
            >
              {loading ? (
                "Sending…"
              ) : (
        ...
        >
          <div className="card rounded-2xl p-6">
            ...
            <div
              style={{ display: "flex", flexDirection: "column", gap: "1rem", padding:20}}
            >
              {[
                {
                  icon: <Mail size={16} />,
                  label: "Email",
                  val: "hello@apexlabel.ng",
                },
                {
                  icon: <Phone size={16} />,
                  label: "Phone",
                  val: "+234 801 234 5678",
                },
                {
                  icon: <MapPin size={16} />,
                  label: "Studio",
                  val: "14 Adetokunbo Ademola St, Victoria Island, Lagos",
                },
              ].map((c) => (
                <div
                  key={c.label}
          ...
          <div className="card rounded-2xl p-6">
            ...
            <div style={{ display: "flex", gap: "0.75rem", justifyContent:"center",padding:10}}>
              {[
