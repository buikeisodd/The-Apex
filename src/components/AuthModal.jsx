        ...
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div
            ...
            style={{
              ...
              height: 3,
              borderRadius: 2,
              background: i <= score ? color : "var(--surface4)",
        ...
        {[
          ...
          <span
            ...
            style={{
              ...
              borderRadius: 10,
              fontFamily: "DM Mono",
              background: checks[c.key] ? `${color}18` : "var(--surface3)",
              color: checks[c.key] ? color : "var(--text-muted)",
              border: `1px solid ${checks[c.key] ? `${color}35` : "transparent"}`,
              transition: "all 0.2s",
              display: "flex",
              alignItems: "center",
              gap: 3,
...
const ROLES = [
  {
    ...
    desc: "Buy beats & book sessions",
  },
  {
    id: "producer",
    label: "Music Producer",
    
    desc: "Upload & sell beats",
  },
  { id: "admin", label: "Admin",  desc: "Label management portal" },
];
const COUNTRIES = [
  "Nigeria",
  "Ghana",
...
export default function AuthModal({ onClose }) {
  ...
  const iStyle = (f) => ({
    ...
    fontSize: "0.875rem",
    border: errors[f] ? "1px solid var(--red)" : undefined,
    boxShadow: errors[f] ? "0 0 0 2px rgba(240,64,64,0.1)" : undefined,
  });
  ...
  const validateStep1 = () => {
    ...
    if (!form.dob) e.dob = "Date of birth is required";
      ...
      if (age < 16) e.dob = "Must be at least 16 years old";
    }
    if (!form.password) e.password = "Password is required";
    else if (form.password.length < 8) e.password = "Minimum 8 characters";
    else if (getPasswordStrength(form.password).level === "weak")
      e.password = "Password too weak — add uppercase, numbers or symbols";
  ...
  const validateStep2 = () => {
    ...
    if (role === "producer" && !form.genre)
      e.genre = "Select your primary genre";
    setErrors(e);
    return Object.keys(e).length === 0;
  };
  ...
  const handleRegisterComplete = (e) => {
    ...
    setTimeout(() => {
      ...
      login({
        ...
        email: form.email,
        avatar: form.firstName[0].toUpperCase(),
        role,
        provider: "Email",
        username: form.username,
      });
    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div
        ...
        style={{
          ...
          width: "100%",
          maxWidth: mode === "register" ? 500 : 440,
          maxHeight: "95vh",
          overflowY: "auto",
          position: "relative",
              ...
              {[1, 2].map((s) => (
                <div
                  ...
                  style={{
                    ...
                    height: 3,
                    borderRadius: 2,
                    background: s <= step ? "var(--gold)" : "var(--surface3)",
                    transition: "background 0.3s",
                  }}
                />
              ))}
            ...
            <>
              ...
              {role === "admin" && (
                ...
                >
                  ...
                  >
                    Admin access is restricted to authorised label staff only.
                  </p>
                </div>
              )}
              <div
              ...
              >
                ...
                >
                  <div style={{ position: "relative" }}>
                    <input
                      className="input-dark"
                      style={{ ...iStyle("password"), paddingRight: "2.75rem" }}
                ...
                >
                  {loading ? (
                    <>
                      <Loader size={14} className="animate-spin-icon" />
                      Signing in…
                    </>
                  ) : (
                    "Sign In"
            ...
            <>
                  ...
                  >
                    ...
                    <p
                      style={{
                        fontSize: "0.75rem",
                        fontWeight: 700,
                        color: role === r.id ? "var(--gold)" : "var(--text)",
                        marginBottom: "0.1rem",
                      }}
                    >
                      {r.label}
              ...
              >
                ...
                <Field
                  ...
                  icon={
                    <span
                      style={{ fontFamily: "DM Mono", fontSize: "0.65rem" }}
                    >
                      @
                    </span>
                  }
                    ...
                    <div
                      ...
                      style={{
                        ...
                        border: errors.agreed
                          ? "1px solid var(--red)"
                          : `1px solid ${agreed ? "var(--gold)" : "rgba(255,255,255,0.15)"}`,
                        background: agreed ? "var(--gold)" : "var(--surface2)",
                        display: "flex",
                        alignItems: "center",
                        justifyContent: "center",
                        flexShrink: 0,
              ...
              >
                ...
                >
                  ...
                  >
                    <select
                      className="input-dark"
                      style={{ ...iStyle("country"), cursor: "pointer" }}
                      value={form.country}
                ...
                {role === "producer" && (
                  ...
                  >
                    <select
                      className="input-dark"
                      style={{ ...iStyle("genre"), cursor: "pointer" }}
                      value={form.genre}
                ...
                <Field
                  label={`Bio ${role === "producer" ? "(your sound)" : "(optional)"}`}
